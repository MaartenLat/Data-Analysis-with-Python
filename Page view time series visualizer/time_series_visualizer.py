...
def draw_bar_plot():
    ...
    chart = sns.barplot(data=df_bar, x="Years", y="Average Page Views", hue="Months", palette="tab10", legend=False)
...
def draw_box_plot():
    ...
    # Monthly boxplot
    sns.boxplot(data=df_box, x="Month", y="Page Views", order=["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ax=axes[1])
